            ...
            <div class="card-body p-5">
              ...
              <form action="{{url('register')}}" method="post"> 
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  ...
                  <input type="text" name="name" class="form-control form-control-lg" placeholder="Enter your name" value="{{old('name')}}" />
                ...
                <div class="d-flex justify-content-center mt-5">
                  <button  type="submit" data-mdb-button-init
                    data-mdb-ripple-init class="btn btn-success w-100  btn-lg gradient-custom-4 text-body">Register</button>
                </div>
